...
export default function EnquirePage() {
  useEffect(() => {
    ...
    function buildWhatsAppMessage() {
      ...
      return [
        "Hi ElysianEventsByNick, I would like to enquire about wedding planning.",
        "",
